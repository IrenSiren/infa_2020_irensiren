...
class gun():
  ...
  def fire2_end(self, event):
    ...
    global balls, bullet
    bullet += 1
    self.an = math.atan2((450 - event.y), (event.x - 40))
    new_ball = ball(20, 450, self.f2_power * math.cos(self.an)/2, - self.f2_power * math.sin(self.an)/2)
    new_ball.set_coords()
    balls += [new_ball]
    self.f2_on = 0
    self.f2_power = 30
